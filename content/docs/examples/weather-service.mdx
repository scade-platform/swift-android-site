...
|:-------------------|:----------------|:----------------|
| • Retrieving current temperature by city name <br/>• Geocoding city names into coordinates <br/>• Fetching weather data using coordinates <br/>• Asynchronous network requests with closures <br/>• Dynamic UI update with fetched temperature <br/>• Reusing Swift logic inside Android UI |• Swift Android compiler <br/>• Swift4J <br/>• SwiftPM Gradle for Android <br/>• Foundation framework <br/>• Swift async/await | [Examples](https://github.com/scade-platform/swift4j-examples) <br/><br/> |
...
<Callout type="warn">
	It is strongly advised that you complete the HelloWorld example beforehand, as it covers essential concepts that are only briefly addressed in this example.
</Callout>
...
![img](./../img/weather-app-android.png)
