...
>>>>>>> 8dfb128c2b9df8a5ad83001d664c65c8723ea801
|:----------|:----------|
...
22. Finally, call the Swift code 
	...
	SCADE interop functionality produces extremely powerful interop code. Calling the Swift code is extremely easy. Add the following code in the next line:
 ...
 (Optional) Make small change to the UI to center the label 
We love beauty, so lets center the label so that the Android app look nice:
	- open the MainActivity.kt file
	- replace the fun Greeting function with the following code
