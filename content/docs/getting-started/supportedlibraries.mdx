...
description: Use a large number of Swift 3rd party libraries on Android
---
...
|----------|----------|----------|----------|----------|
| Core  | Swift Foundation   | Access all Foundation functionality in Android   |  [WeatherService](https://github.com/scade-platform/swift4j-examples/tree/main/Packages/WeatherService)  | HTTP|
